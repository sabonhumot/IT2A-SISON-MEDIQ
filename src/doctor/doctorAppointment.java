...
public class doctorAppointment extends javax.swing.JFrame {
    ...
    public void displayData() {
        try {
            ...
            ResultSet rs = con.getData(
                    "SELECT a.appointment_id, CONCAT(u.u_fname, ' ', u.u_lname) AS patient_name, "
    ...
    private void activateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_activateActionPerformed
        ...
        String id = appointmentsTable.getValueAt(selectedRow, 0).toString();

        connectDB con = new connectDB();

        session sess = session.getInstance();

        con.updateData("UPDATE appointments SET appointment_status = 'Accepted' WHERE appointment_id = '" + id + "'");

        con.insertData("INSERT INTO logs (u_id, action, action_date, action_time)"
                + "VALUES ('" + sess.getU_id() + "', 'Accepted an appointment', '" + actionDate + "', '" + actionTime + "')");
